        ...
        <div className="max-w-[2020px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-0 md:-mt-29">
          ...
          <div className="max-w-4xl px-0 sm:px-4 lg:pl-40 lg:pr-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                onClick={(e) => smoothScrollTo(e as any, '#projects')} 
                className="px-8 py-4 border border-purple-500 text-purple-400 rounded-full hover:bg-purple-500/10 transition-colors text-sm font-medium tracking-wide"
              >
                View Projects →
              </button>
              <button 
                onClick={(e) => smoothScrollTo(e as any, '#contact')} 
                className={`px-8 py-4 rounded-full transition-colors text-sm font-medium tracking-wide ${themeClasses.button}`}
              >
                Contact Us →
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <p className={`text-sm leading-relaxed mb-4 ${
                ...
                Transforming businesses into industry leaders through integrated digital solutions and scalable technology infrastructure.
              </p>
              <div className="flex gap-4">
                <a href="https://github.com/UKRUSH" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-400 transition-colors">
                ...
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#company" onClick={(e) => smoothScrollTo(e, '#company')} className={`text-sm transition-colors ${
                ...
                <li>
                  <a href="#services" onClick={(e) => smoothScrollTo(e, '#services')} className={`text-sm transition-colors ${
                    theme === 'dark' ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'
                  }`}>
                    Our Services
                  </a>
                ...
                <li>
                  <a href="#projects" onClick={(e) => smoothScrollTo(e, '#projects')} className={`text-sm transition-colors ${
                    theme === 'dark' ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'
                  }`}>
                    Case Studies
                  </a>
                ...
                <li>
                  <a href="#contact" onClick={(e) => smoothScrollTo(e, '#contact')} className={`text-sm transition-colors ${
                    theme === 'dark' ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'
                  }`}>
                    Contact Us
                  </a>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <a href="tel:+94777960231" className={`text-sm transition-colors ${
                    theme === 'dark' ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'
                  }`}>
                    +94 77 796 0231
                  </a>
          ...
          <div className={`pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 ${
            ...
            <p className={`text-sm ${
              ...
              © {new Date().getFullYear()} BizMaster Solutions. All rights reserved.
            </p>
